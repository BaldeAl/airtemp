      ...
      <div className="w-full max-w-md">
        <div className="card-cartoon p-6 sm:p-8">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-extrabold text-[#2D3436] dark:text-white">
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <label
                htmlFor="isHost"
                className="text-sm font-bold text-[#636E72] dark:text-[#B2BEC3]"
              >
                        ...
                        {identityFileName ? (
                          <>
                            ...
                            <p className="text-xs text-[#00B894] font-semibold">
                              {t("auth.documentUploaded")}
                            </p>
                          </>
                        ) : (
                          <>
                            <p className="text-sm font-bold text-[#636E72] dark:text-[#B2BEC3]">
                              {t("auth.uploadIdentity")}
                            </p>
                            <p className="text-xs text-[#B2BEC3]">
                              {t("auth.uploadFormats")}
                            </p>
                          </>
                        )}
                      </div>
          ...
          {message && (
            <div
              className={`mt-4 flex items-center gap-2 p-3 rounded-2xl ${message.includes("success") ? "bg-[#55EFC4]/15 text-[#00B894]" : "bg-[#FF6B6B]/10 text-[#FF6B6B]"}`}
            >
          ...
          <div className="text-center mt-6">
            <Link
              className="text-sm font-bold text-[#4ECDC4] hover:text-[#3BADA6] transition-colors"
              href="/Auth/login/"
            >
