...
export default function AdminDashboard() {
  ...
  const handleToggleRole = async (userId, action) => {
    ...
    const confirmMsg =
      action === "revoke" ? t("admin.revokeConfirm") : t("admin.grantConfirm");
  ...
  const revokedHosts = hosts.filter(
    (h) => h.role === "USER" && h.identityDocument,
  );
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 sm:py-12">
          ...
          <div className="flex items-center gap-2 mb-6 animate-fade-in-up flex-wrap">
            ...
            >
              ...
              <span
                className={`px-1.5 py-0.5 rounded-full text-xs ${activeTab === "pending" ? "bg-white/20 dark:bg-black/20" : "bg-[#E8E8E4] dark:bg-[#3D3D5C]"}`}
              >
                {pendingHosts.length}
              </span>
            </button>
            ...
            >
              ...
              <span
                className={`px-1.5 py-0.5 rounded-full text-xs ${activeTab === "approved" ? "bg-white/20 dark:bg-black/20" : "bg-[#E8E8E4] dark:bg-[#3D3D5C]"}`}
              >
            ...
            >
              {t("admin.revoked")}
              <span
                className={`px-1.5 py-0.5 rounded-full text-xs ${activeTab === "revoked" ? "bg-white/20 dark:bg-black/20" : "bg-[#E8E8E4] dark:bg-[#3D3D5C]"}`}
              >
                {revokedHosts.length}
              </span>
            </button>
